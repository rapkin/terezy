...
badx = []
for other in ("docs/REQUIRED_TESTS.md", "data/README.md"):
    for m in re.finditer(r"METHODOLOGY\.md`? §(\d+(?:\.\d+)?)", pathlib.Path(other).read_text()):
        if m.group(1) not in known:
            badx.append((other, m.group(1)))
...
print(  # noqa: T201
    "unresolved cross-file     :", badx or "none"
)
print(  # noqa: T201
