...
:func:`terezy.core.instruments.accrual.schedule_of`, which reads the **paid** dates as the
boundaries a dated quotation is carried between -- a coupon leaves the price on the day it is
paid. An implementation that trimmed the
