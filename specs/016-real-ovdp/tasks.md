...
- [x] T021 Re-measure and re-record every site under *Counts that move*: `tests/worked_examples/test_candidate_accounting.py`, `tests/worked_examples/test_candidate_enumeration.py`, `tests/unit/test_every_refusal_through_the_loop.py`, `specs/014-candidates/spec.md`, `specs/014-candidates/plan.md`, and feature 015's note in `specs/features.toml`. Replace a count by a derivation wherever one is available (FR-025).
