...
same footing, as labelled synthetic fixtures until real ones arrive; and `seeds/` declares an
owner holding nothing, because a synthetic lot needs a synthetic instrument and those no longer
ship. Every one of them is committed **because what ships in it is synthetic** — rule 5 above,
and the owner's own rule. None of them is a licence to commit his actual position.
