...
| `observations/` | Dated snapshots of what a platform publishes about its own instruments, written by a fetch script and read by nothing at run time — the evidence a declaration was checked against, kept so a later correction can name what it saw. |
